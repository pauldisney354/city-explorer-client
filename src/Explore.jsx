...
class Explore extends React.Component {
  ...
  getWeather = async () => {
    try{
      const weather = await axios.get(`${SERVER_URL}/weather`, {params: {lat: this.state.latitude, lon: this.state.longitude} } );
      this.setState({
  ...
  getMovies = async () => {
    try{
      const movies = await axios.get(`${SERVER_URL}/movies`, {params: {city:this.state.searchQuery}});
      this.setState({
        movies: movies.data
      });
    } catch(error){
  ...
  getYelp = async () => {
    try{
      const yelp = await axios.get(`${SERVER_URL}/yelp`, {params: {searchQuery: this.state.searchQuery}});
      this.setState({
        yelp: yelp.data
      });
    } catch(error) {
